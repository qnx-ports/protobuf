...
ABSL_MUST_USE_RESULT bool HasExtension(
  ...
  return ::hpb::internal::HasExtensionOrUnknown(
      hpb::interop::upb::GetInternalMsg(message), id.mini_table_ext());
}
...
void ClearExtension(
  ...
  upb_Message_ClearExtension(hpb::interop::upb::GetInternalMsg(message),
                             id.mini_table_ext());
}
...
absl::Status SetExtension(
  ...
  return ::hpb::internal::SetExtension(
      hpb::interop::upb::GetInternalMsg(message), message_arena,
      id.mini_table_ext(), hpb::interop::upb::GetInternalMsg(&value));
}
...
absl::Status SetExtension(
  ...
  return ::hpb::internal::MoveExtension(
      hpb::interop::upb::GetInternalMsg(message), message_arena,
      id.mini_table_ext(), hpb::interop::upb::GetInternalMsg(&ext),
      extension_arena);
}
...
absl::StatusOr<Ptr<const Extension>> GetExtension(
  ...
  const bool ok = ::hpb::internal::GetOrPromoteExtension(
      const_cast<upb_Message*>(hpb::interop::upb::GetInternalMsg(message)),
...
typename T::Proxy CloneMessage(Ptr<T> message, upb_Arena* arena) {
  return ::hpb::internal::PrivateAccess::Proxy<T>(
      ::hpb::internal::DeepClone(hpb::interop::upb::GetInternalMsg(message),
                                 T::minitable(), arena),
      arena);
}
...
void DeepCopy(Ptr<const T> source_message, Ptr<T> target_message) {
  ...
  ::hpb::internal::DeepCopy(
      hpb::interop::upb::GetInternalMsg(target_message),
      hpb::interop::upb::GetInternalMsg(source_message), T::minitable(),
...
ABSL_MUST_USE_RESULT bool Parse(Ptr<T> message, absl::string_view bytes) {
  static_assert(!std::is_const_v<T>);
  upb_Message_Clear(hpb::interop::upb::GetInternalMsg(message),
  ...
  return upb_Decode(bytes.data(), bytes.size(),
                    hpb::interop::upb::GetInternalMsg(message),
                    ::hpb::interop::upb::GetMiniTable(message),
...
absl::StatusOr<absl::string_view> Serialize(const T* message, upb::Arena& arena,
                                            int options = 0) {
  return ::hpb::internal::Serialize(hpb::interop::upb::GetInternalMsg(message),
                                    ::hpb::interop::upb::GetMiniTable(message),
                                    arena.ptr(), options);
}
